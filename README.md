...
- Hover Info - Documentation appears when you hover over a function, class, or code note.
- Error Diagnostics - Compiler errors reported on specific text that violate the language definition.
