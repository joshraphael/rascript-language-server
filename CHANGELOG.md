...
## [[0.5.2](https://github.com/joshraphael/rascript-language-server/releases/tag/v0.5.2)] - 2026-MM-DD

[diff](https://github.com/joshraphael/rascript-language-server/compare/v0.5.1...v0.5.2)
...
[diff](https://github.com/joshraphael/rascript-language-server/compare/v0.5.0...v0.5.1)

### Added

- Add RATools Error Diagnostics
...
## [[0.4.1](https://github.com/joshraphael/rascript-language-server/releases/tag/v0.4.1)] - 2026-01-20

[diff](https://github.com/joshraphael/rascript-language-server/compare/v0.4.0...v0.4.1)
...
- Out of bounds index crash ([#4](https://github.com/joshraphael/rascript-language-server/issues/4))
